...
logger = logging.getLogger("negosphere.orchestrator")

class AgentOrchestrator:
    """
    Central Orchestrator Pipeline for AI Negotiator Showdown.
    ...
    async def run_full_pipeline(
        ...
        logger.info(f"Starting multi-agent orchestrator pipeline for query: '{query}'")
